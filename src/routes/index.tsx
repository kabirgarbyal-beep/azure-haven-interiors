...
import luxeScriptUrl from "../luxe.js?url";
  ...
  head: () => ({
    meta: [
      { title: "Maison Lumière — Luxury Interior Design Atelier" },
      {
        name: "description",
        content:
          "Maison Lumière is a luxury interior design atelier crafting villas, penthouses and signature residences with architectural elegance.",
      },
      { property: "og:title", content: "Maison Lumière — Luxury Interior Atelier" },
      {
        property: "og:description",
        content: "Architectural interiors for villas, penthouses and signature residences.",
      },
